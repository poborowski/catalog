    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('api') ? 'is-invalid' : '' }}" type="number" name="api" id="api" value="{{ old('api', '') }}" step="1">
                @if($errors->has('api'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_id_wordpress') ? 'is-invalid' : '' }}" type="text" name="product_id_wordpress" id="product_id_wordpress" value="{{ old('product_id_wordpress', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_personalized') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_personalized" id="is_personalized" value="1" {{ old('is_personalized', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_free_sample_btn') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_free_sample_btn" id="show_free_sample_btn" value="1" {{ old('show_free_sample_btn', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_availability') ? 'is-invalid' : '' }}" type="text" name="product_availability" id="product_availability" value="{{ old('product_availability', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('realization_time') ? 'is-invalid' : '' }}" type="text" name="realization_time" id="realization_time" value="{{ old('realization_time', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attributes_from_poligrafia_api') ? 'is-invalid' : '' }}" type="text" name="attributes_from_poligrafia_api" id="attributes_from_poligrafia_api" value="{{ old('attributes_from_poligrafia_api', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('change_price_when') ? 'is-invalid' : '' }}" type="text" name="change_price_when" id="change_price_when" value="{{ old('change_price_when', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attach_additional_product') ? 'is-invalid' : '' }}" type="text" name="attach_additional_product" id="attach_additional_product" value="{{ old('attach_additional_product', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disable_from_delivery') ? 'is-invalid' : '' }}" type="text" name="disable_from_delivery" id="disable_from_delivery" value="{{ old('disable_from_delivery', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_rating') ? 'is-invalid' : '' }}" type="text" name="product_rating" id="product_rating" value="{{ old('product_rating', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_desc_long') ? 'is-invalid' : '' }}" type="text" name="product_desc_long" id="product_desc_long" value="{{ old('product_desc_long', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_desc_short') ? 'is-invalid' : '' }}" type="text" name="product_desc_short" id="product_desc_short" value="{{ old('product_desc_short', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_desc_dane') ? 'is-invalid' : '' }}" type="text" name="product_desc_dane" id="product_desc_dane" value="{{ old('product_desc_dane', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('images_urls') ? 'is-invalid' : '' }}" type="text" name="images_urls" id="images_urls" value="{{ old('images_urls', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dimension') ? 'is-invalid' : '' }}" type="text" name="dimension" id="dimension" value="{{ old('dimension', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_product_style') ? 'is-invalid' : '' }}" type="text" name="filters_product_style" id="filters_product_style" value="{{ old('filters_product_style', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_product_type') ? 'is-invalid' : '' }}" type="text" name="filters_product_type" id="filters_product_type" value="{{ old('filters_product_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_color_dominant') ? 'is-invalid' : '' }}" type="text" name="filters_color_dominant" id="filters_color_dominant" value="{{ old('filters_color_dominant', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_products_decoration') ? 'is-invalid' : '' }}" type="text" name="filters_products_decoration" id="filters_products_decoration" value="{{ old('filters_products_decoration', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_product_photo') ? 'is-invalid' : '' }}" type="text" name="filters_product_photo" id="filters_product_photo" value="{{ old('filters_product_photo', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filters_product_format') ? 'is-invalid' : '' }}" type="text" name="filters_product_format" id="filters_product_format" value="{{ old('filters_product_format', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_url_feed') ? 'is-invalid' : '' }}" type="text" name="photo_url_feed" id="photo_url_feed" value="{{ old('photo_url_feed', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disable_from_feed') ? 'is-invalid' : '' }}" type="text" name="disable_from_feed" id="disable_from_feed" value="{{ old('disable_from_feed', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('categories') ? 'is-invalid' : '' }}" type="text" name="categories" id="categories" value="{{ old('categories', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_variant_family') ? 'is-invalid' : '' }}" type="text" name="product_variant_family" id="product_variant_family" value="{{ old('product_variant_family', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_collection') ? 'is-invalid' : '' }}" type="text" name="product_collection" id="product_collection" value="{{ old('product_collection', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_to_org_product') ? 'is-invalid' : '' }}" type="text" name="link_to_org_product" id="link_to_org_product" value="{{ old('link_to_org_product', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_templatebindingtype') ? 'is-invalid' : '' }}" type="text" name="poligrafia_templatebindingtype" id="poligrafia_templatebindingtype" value="{{ old('poligrafia_templatebindingtype', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_templateid') ? 'is-invalid' : '' }}" type="text" name="poligrafia_templateid" id="poligrafia_templateid" value="{{ old('poligrafia_templateid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_manufacturer') ? 'is-invalid' : '' }}" type="text" name="poligrafia_manufacturer" id="poligrafia_manufacturer" value="{{ old('poligrafia_manufacturer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_creator_type') ? 'is-invalid' : '' }}" type="text" name="poligrafia_creator_type" id="poligrafia_creator_type" value="{{ old('poligrafia_creator_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_product_code_antigro') ? 'is-invalid' : '' }}" type="text" name="poligrafia_product_code_antigro" id="poligrafia_product_code_antigro" value="{{ old('poligrafia_product_code_antigro', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poligrafia_product_source') ? 'is-invalid' : '' }}" type="text" name="poligrafia_product_source" id="poligrafia_product_source" value="{{ old('poligrafia_product_source', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_product_url') ? 'is-invalid' : '' }}" type="text" name="actual_product_url" id="actual_product_url" value="{{ old('actual_product_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('featured_img') ? 'is-invalid' : '' }}" type="text" name="featured_img" id="featured_img" value="{{ old('featured_img', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preview_featured_image') ? 'is-invalid' : '' }}" type="text" name="preview_featured_image" id="preview_featured_image" value="{{ old('preview_featured_image', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_filters_products_decoration') ? 'is-invalid' : '' }}" type="text" name="contact_filters_products_decoration" id="contact_filters_products_decoration" value="{{ old('contact_filters_products_decoration', '') }}">
